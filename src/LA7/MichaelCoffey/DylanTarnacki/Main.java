...
public class Main {
	...
	public static void main(String[] args) throws IOException {
		...
		BufferedReader fileIn = new BufferedReader(new FileReader("C:\\Users\\Dylan\\git\\LA7\\course.txt"));
		BufferedReader fileIn1 = new BufferedReader(new FileReader("C:\\Users\\Dylan\\git\\LA7\\request.txt"));
